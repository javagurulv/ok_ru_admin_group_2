...
class MAthOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result 10 - 5 = " + subtraction2.calculate());
        ...
        System.out.println("Result 20 / 5 = " + division.calculate());

        // build and calculate: (10 - 5) * (20 / 5)
        MathOperation result = new Multiplication(subtraction2, division);
        System.out.println("Result (10 - 5) * (20 / 5) = " + result.calculate());
    }
