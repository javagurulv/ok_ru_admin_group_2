package student_dmitry_drozdetsky.lesson_6.level_6.Task_27;
...
public class TicTacToe {
        ...
        public boolean isWinPositionForHorizontals(int[][] field, int playerToCheck) {
            for (int[] line: field)
                if ((line[0] == playerToCheck)
                        ...
                        && (line[2] == playerToCheck)) return true;
            return false;
        }
        ...
        public boolean isDrawPosition(int[][] field) {
            var someoneWin = (isWinPosition(field, 0)
        ...
        public int[][] createField() {
            ...
            for (int i = 0; i < 3; i ++) for (int j = 0; j < 3; j++) array[i][j] = -1;
            return array;
        }
}
