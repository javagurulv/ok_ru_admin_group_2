...
class CalculatorTest {
    ...
    public static void main(String[] args) {
        ...
        calculatorTest.maxTest(10, 5, 10);
        calculatorTest.maxTest(5, 20, 20);
        calculatorTest.maxTest(5,5,5);
    }
    ...
    public void maxTest(int firstNumber, int secondNumber, int expectedResult) {
        Calculator calculator = new Calculator();
