...
public class InMemoryDatabaseTest {
    ...
    public void shouldFindByTitle() {
        ...
        database.save(product4);
        database.save(product5);
        Product testProduct = new Product("Butter");
        Optional<Product> expected = Optional.of(testProduct);
        Optional<Product> actual = database.findByTitle("Butter");
    ...
    public void shouldNotFindByTitle() {
        ...
        database.save(product4);
        database.save(product5);
        Product testProduct = new Product("Crisps");
        Optional<Product> expected = Optional.of(testProduct);
        Optional<Product> actual = database.findByTitle("Crisps");
        boolean result = expected.equals(actual);
